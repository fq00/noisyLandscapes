...
dataPlot <- read.csv(file = "Runtime/cGA_runtime.txt", header = TRUE, sep = " ", skip = 15)
names(dataPlot) <- read.csv(file = "Runtime/cGA_runtime.txt", header = FALSE, sep = " ", nrows = 1, skip = 14, as.is = TRUE)
...
png("Runtime/cGA_runtime.png", width = 1920, height = 1200, units = "px")
g <- NA
