...
dataPlot <- read.csv(file = "Runtime/GA_runtime.txt", header = TRUE, sep = " ", skip = 14)
...
png("Runtime/GA_runtime.png", width = 1920, height = 1200, units = "px")
g <- NA
