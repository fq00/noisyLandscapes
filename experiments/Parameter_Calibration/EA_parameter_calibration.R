...
data <- read.csv(file = "Parameter_Calibration/EA_parameter_calibration.txt", header = TRUE, sep = " ", skip = 14)
dataPlot <- data.frame()
...
png("Parameter_Calibration/EA_parameter_calibration.png", width = 1920, height = 1200, units = "px")
g <- NA
